...
import { getEstaciones } from '../Services/Estaciones/index.js'
...
export const EstacionesProvider = ({children}) => {
    ...
    useEffect(() => {
      const obtenerEstaciones = async () => {
        try {
          const estacionesData = await getEstaciones();
      ...
      obtenerEstaciones();
      //Esto se debe comentar si se usa las estaciones del back
      //setEstaciones(estacionesDataEstatica);
    }, []);
